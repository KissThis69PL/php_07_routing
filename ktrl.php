...
getRouter()->addRoute('calcShow',    'KalKtrl',  ['user','admin']);
getRouter()->addRoute('calcCompute', 'KalKtrl',  ['user','admin']);
getRouter()->addRoute('login',       'LoginKtrl');
getRouter()->addRoute('logout',      'LoginKtrl', ['user','admin']);
